...
│   ├── test_booking_variants.py   # Diagnostic variantes URL Booking
│   └── debug_booking_html.py      # Inspection HTML brut Booking
├── Kayak_Notebook_Pure.ipynb      # Notebook exécutable (pipeline complet commenté)
...
Ouvrir `Kayak_Notebook_Pure.ipynb` depuis la racine du projet et exécuter les cellules dans l'ordre. Chaque cellule est commentée.
